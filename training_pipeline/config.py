...
class TrainingConfig:
    ...
    positive_sample_weight: int = 20 # Oversample các mẫu positive (code smell) 20 lần
    ...
    neftune_noise_alpha: float = 15.0 # Kích nhiễu vector không gian NEFTune mức vừa
    label_smoothing_factor: float = 0.1 # Tránh model tự tin 100% gây sập loss
    ...
    # Kỹ thuật mở rộng (Anti-overfitting / Efficiency)
